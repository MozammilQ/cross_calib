...
def rabi_drag_experiment(backend, q_scale, rough_q_freq_Hz, qubit_n=0, mem_slot=0, rabi_points=50, drive_ampl_min=0, drive_ampl_max=0.75, drive_sigma_us=0.075,  shots_per_point=1024):
    ...
    with pulse.build(backend=backend, default_alignment='sequential', name='Rabi Experiment') as rabi_sched:
        ...
        drag_pulse=pulse.Drag(duration=drive_duration, amp=drive_ampl, sigma=drive_sigma, beta=q_scale, name="Rabi Pulse")
        pulse.play(drag_pulse, drive_chanl)
