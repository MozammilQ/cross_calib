...
def q_scale(backend, drive_duration_us, drive_sigma_us, precise_q_freq_Hz, amplitude, qubit_n=0, mem_slot=0, num_of_experiments=60, q_s_min=-1.5, q_s_max=+1.5, num_of_shots_per_point=1024):
